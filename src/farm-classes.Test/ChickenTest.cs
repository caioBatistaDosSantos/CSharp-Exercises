...
public class ChickenTest
{
    ...
    {
        var NewChicken = new Chicken(eggsPerWeek);

        NewChicken.Should().NotBeNull();
        NewChicken.Should().BeOfType<Chicken>();

        NewChicken.EggsPerWeek.Should().Be(expectedEggsPerWeek);
    }
    ...
    {
        var NewChicken = new Chicken(eggsPerWeek, mother);
